                ...
                <form role="form" method="post" action="{{(URL::to('/update-product/'.$pro->product_id))}}" enctype="multipart/form-data">
                  {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="product-price" value="{{$pro->product_price}}" name="product_price">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{URL::to('public/uploads/product/'.$pro->product_image)}}" height="100" width="auto">
                    </div>
                    <div class="form-group">
